...
case class AtomJsonParsingError(message: String)
  extends AtomAPIError(s"Failed to parse Json string with error: $message")
case class AtomThriftDeserialisingError(message: String, detail: Map[String,String])
  extends AtomAPIError(s"Failed to deserialise JSON into thrift with error: $message")
